...
cacheserver2::CCacheClient goCacheClient;
...
apl_int_t Initialize( char const* apcConfig, cacheserver2::CCacheClient* apoClient )
{
...
int main( int argc, char* argv[] )
{
	...
	if (Initialize("../config/CacheClient.ini", &goCacheClient) != 0 )
	{
