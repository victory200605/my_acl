...
class Submit(CMPP_Object):
    ...
    DEFINE_LIST = (
        ...
        ("fee_terminal_id",     "32s",  str,    None),
        ("fee_terminal_type",   "B",    int,    None),
        ("tp_pid",              "B",    int,    None),
        ("tp_udhi",             "B",    int,    None),
        ("msg_fmt",             "B",    int,    None),
        ("msg_src",             "6s",   str,    None),
        ...
        ("dest_terminal_ids",   "32s",  list,   "dest_usr_tl"),
        ("dest_terminal_type",  "B",    int,    None),
        ("msg_length",          "B",    int,    None),
        ("msg_content",         "s",    str,    "msg_length"),
        ("link_id",             "20s",  str,    None),
    )
...
class Deliver(CMPP_Object):
    ...
    DEFINE_LIST = (
        ...
        ("tp_udhi",             "B",    int,    None),
        ("msg_fmt",             "B",    int,    None),
        ("src_terminal_id",     "32s",  str,    None),
        ("src_terminal_type",   "B",    int,    None),
        ("registered_delivery", "B",    int,    None),
        ("msg_length",          "B",    int,    None),
        ("msg_content",         "s",    str,    "msg_length"),
        ("link_id",             "20s",  str,    None),
...
class Fwd(CMPP_Object):
    ...
    DEFINE_LIST = (
        ...
        ("fee_terminal_pseudo",     "32s",  str,    None),
        ("fee_terminal_user_type",  "B",    int,    None),
        ("tp_pid",                  "B",    int,    None),
        ("tp_udih",                 "B",    int,    None),
        ("msg_fmt",                 "B",    int,    None),
        ("msg_src",                 "6s",   str,    None),
        ...
        ("at_time",                 "17s",  str,    None),
        ("src_id",                  "21s",  str,    None),
        ("src_pseudo",              "32s",  str,    None),
        ("src_type",                "B",    int,    None),
        ("dest_usr_tl",             "B",    int,    None), #must be 1
        ("dest_id",                 "21s",  str,    None),
        ("dest_pseudo",             "32s",  str,    None),
        ("msg_length",              "B",    int,    None),
        ("msg_content",             "s",    str,    "msg_length"),
        ("link_id",                 "20s",  str,    None),
    )
