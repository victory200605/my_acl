...
namespace gfq2 {
    ...
    enum {
        ...
        ERROR_INVALID_MESSAGE      = -80113,
        ERROR_NODE_EXISTED         = -80114,
        ERROR_NODE_UNEXISTED       = -80115,
        ERROR_QUEUE_EXISTED        = -80116,
        ERROR_SEGMENT_EXISTED      = -80117,
        ERROR_SEGMENT_UNEXISTED    = -80118,
        ERROR_OUT_OF_RANGE         = -80119,
        ERROR_NO_ENOUGH_SPACE      = -80120,
        ERROR_INVALID_QUEUE        = -80121,
        ERROR_INVALID_SEGMENT      = -80122,
        ERROR_UNIMPLEMENTED        = -80123,
    ...
    inline const char* StrError( int aiErrNo )
    {
        switch(aiErrNo)
        {
            ...
            case ERROR_NODE_EXISTED:                  return "Server node existed";
...
#define GFQ_MEMBER_METHOD_STR( name ) \
    ...
    void Set##name( char const* apc##name ) { this->mo##name = apc##name; }
